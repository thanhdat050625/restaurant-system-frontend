          ...
          <>
            ...
            <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
              ...
              <button
                ...
                onClick={handleSave}
                disabled={saving}
                className="inline-flex items-center gap-2 px-5 py-2 bg-primary hover:bg-primary-dark text-white rounded-lg text-sm font-bold shadow-sm transition-all cursor-pointer disabled:opacity-50"
              >
                {saving ? (
                  <>
